...
SERVER_URL = "https://weather-mcp-server-anvu.onrender.com"
...
async def run_agent(user_message: str):
    async with httpx.AsyncClient(timeout=30) as client:
        ...
        await send(client, post_path, "initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "raw-agent", "version": "1.0"}
        })
...
if __name__ == "__main__":
    asyncio.run(run_agent("Какая сейчас погода в Москве и Лондоне?"))
