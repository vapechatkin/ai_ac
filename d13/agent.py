"""
CLI-агент с оркестрацией по этапам задачи (d13).
...
from memory import (
    ...
    PROFILE_FIELDS, PREF_FIELDS, STAGES, STAGE_TRANSITIONS, WAITING, WORKING,
)
...
HELP_TEXT = """
╔══════════════════════════════════════════════════════════════════╗
║                АГЕНТ-ОРКЕСТРАТОР  (d13)                          ║
╠══════════════════════════════════════════════════════════════════╣
║  РАБОЧИЙ ПРОЦЕСС                                                 ║
║  planning → execution → validation → done                        ║
║                                                                  ║
║  /confirm           подтвердить переход на следующий этап/шаг    ║
║  /back              откатиться на предыдущий этап                ║
║  /status            текущий этап, шаг, ожидаемое действие       ║
╠══════════════════════════════════════════════════════════════════╣
║  ЗАДАЧИ                                                          ║
